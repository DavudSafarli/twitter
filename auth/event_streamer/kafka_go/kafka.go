...
// func (k Kafka) PublishUserSignupEvent(ctx context.Context, event auth.UserEvent) error {
...
// func (k Kafka) RegisterUserSignupEventConsumer(ctx context.Context, HandlerFn func(event auth.UserEvent)) io.Closer {
